...
3. [Step 1 – Understanding the Existing SoC](#understanding-the-existing-soc)
4. [Step 2 – GPIO IP RTL Design](#gpio-ip-rtl-design)
5. [Step 3 – SoC Integration](#soc-integration)
6. [Step 4 – Firmware & Simulation Validation](#firmware--simulation-validation)
7. [Step 5 – Hardware Build Flow (Optional)](#hardware-build-flow-optional)
